...
# theta_hpd = pm.hpd(chain_0['theta'])[idx]
    theta_hpd = az.hdi(chain_0['theta'])[idx]
...
# trace_s = pm.sample(2000, njobs=1)
    trace_s = pm.sample(2000, chains=1)
...
# trace_sf = pm.sample(5000, njobs=1)
    trace_sf = pm.sample(5000, chains=1)
...
# trace_lda = pm.sample(5200, njobs=1) 
    trace_lda = pm.sample(5200, chains=1)
