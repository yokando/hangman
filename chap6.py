...
#  trace_l = pm.sample(2100, njobs=1)
  trace_l = pm.sample(2100, chains=1)
...
#  trace_p = pm.sample(2100, njobs=1)
    trace_p = pm.sample(2100, chains=1)
...
#  trace_BF = pm.sample(5500, njobs=1)
  trace_BF = pm.sample(5500, chains=1)
...
#  trace_BF_0 = pm.sample(5500, njobs=1)
  trace_BF_0 = pm.sample(5500, chains=1)  
...
#  trace_BF_1 = pm.sample(5500, njobs=1)
  trace_BF_1 = pm.sample(5500, chains=1)
